...
QT_MOC_LITERAL(12, 140, 21), // "on_switch_fan_clicked"
QT_MOC_LITERAL(13, 162, 22), // "on_switch_humi_clicked"
...
void MonitorArea::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MonitorArea *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        case 4: _t->on_switch_fan_clicked(); break;
        case 5: _t->on_switch_humi_clicked(); break;
        ...
        {
            using _t = void (MonitorArea::*)(int , DevType , DataType , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MonitorArea::sigControlDevice)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject MonitorArea::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_MonitorArea.data,
    qt_meta_data_MonitorArea,
    qt_static_metacall,
    nullptr,
    nullptr
} };
