...
QT_MOC_LITERAL(11, 190, 24) // "on_checkBox_auto_clicked"
    ...
    "QListWidgetItem*\0item\0on_btn_save_clicked\0"
    "on_checkBox_auto_clicked"
};
...
void SettingWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 7: _t->on_checkBox_auto_clicked(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SettingWindow::sigShowMainWnd)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (SettingWindow::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SettingWindow::sigSaveSettings)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject SettingWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_SettingWindow.data,
